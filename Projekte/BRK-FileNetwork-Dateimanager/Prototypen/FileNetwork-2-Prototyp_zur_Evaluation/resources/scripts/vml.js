...
rabbit.result.manager.init=function(_60,_61,_62){
rabbit.prototypeType=_61;
rabbit.browser=_62;
try{
var _63=document.getElementById("pageData").firstChild;
var _64="";
while(_63!=null){
_64+=_63.nodeValue;
_63=_63.nextSibling;
}
this.pageData=Ext.util.JSON.decode(_64).pages;
var _65=document.getElementsByTagName("div");
this.layers=new Array();
for(var i=0;i<_65.length;i++){
if(_65[i].getAttribute("name")=="layer"){
this.layers.push(_65[i]);
}
}
for(var _66 in this.pageData){
...
_67[i].getElementsByTagName("fill")[0].setAttribute("on","true");
}
}
}
...
rabbit.result.manager.changeTab=function(_68){
var _69=selectorUtil.getElementsByName("target"+this.currentPageId);
for(var i=0;i<_69.length;i++){
if(_69[i].childNodes.length==2){
_69[i].firstChild.style.display="block";
_69[i].firstChild.nextSibling.style.display="none";
}else{
_69[i].getElementsByTagName("fill")[0].setAttribute("color","white");
}
}
var _69=selectorUtil.getElementsByName("target"+_68);
for(var i=0;i<_69.length;i++){
if(_69[i].childNodes.length==2){
_69[i].firstChild.style.display="none";
_69[i].firstChild.nextSibling.style.display="block";
}else{
_69[i].getElementsByTagName("fill")[0].setAttribute("color","#D3D3D3");
}
}
this.currentPageId=_68;
};
YAHOO.widget.Menu.prototype._onBeforeShow=function(_6a,_6b){
var _6c,n,_6d,_6e=this.cfg.getProperty("container");
...
_6d=this.srcElement;
if(_6d){
if(_6d.tagName.toUpperCase()=="SELECT"){
if(Dom.inDocument(_6d)){
this.render(_6d.parentNode);
}else{
this.render(_6e);
}
}else{
...
var _6f=this.parent,_70;
if(!_6f&&this.cfg.getProperty("position")=="dynamic"){
this.cfg.refireEvent("xy");
}
if(_6f){
_70=_6f.parent.cfg.getProperty("submenualignment");
this._initSubTree();
this.cfg.setProperty("context",[_6f.element,_70[0],_70[1]]);
this.align();
}
};
